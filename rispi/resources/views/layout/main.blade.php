                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img
                                            src="{{ asset('images/faces/face4.jpg" alt="image" class="profile-pic') }}">
                                    </div>
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img
                                            src="{{ asset('images/faces/face2.jpg" alt="image" class="profile-pic') }}">
                                    </div>
                                    <div class="preview-item-content flex-grow">
                                ...
                                <a class="dropdown-item preview-item">
                                    <div class="preview-thumbnail">
                                        <img
                                            src="{{ asset('images/faces/face3.jpg" alt="image" class="profile-pic') }}">
                                    </div>
                                    <div class="preview-item-content flex-grow">
